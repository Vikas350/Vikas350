...
[![My Skills](https://skillicons.dev/icons?i=react,redux,materialui,nodejs,express,nestjs,mongodb,vercel,vue,vuetify,tailwind,html,css,js,mysql,cpp,c,python,flask,git,firebase,linux,aws,gcp,postgresql,graphql)](https://skillicons.dev)
